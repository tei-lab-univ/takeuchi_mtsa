...
public class TestPartialOrderReduction {

    private static final String[] RESOURCE_FOLDERS = {"PartialOrderReduction/ControllableFSPs","PartialOrderReduction/NoControllableFSPs"};
    private static final String FSP_NAME = "C";
    private File ltsFile;


    public TestPartialOrderReduction(File getFile) {
        ltsFile = getFile;
